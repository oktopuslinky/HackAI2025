def get_descriptions(filename):
    ...
    for image in images_with_text:
        ...
        client = OpenAI(
            api_key="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"
        )
